...
def test_right_click_drawing(qapp):
    ...
    press_event = QMouseEvent(
        QEvent.MouseButtonPress, p_e2, Qt.RightButton, Qt.RightButton, Qt.NoModifier
    )
    ...
    move_event = QMouseEvent(
        QEvent.MouseMove, p_e4, Qt.NoButton, Qt.RightButton, Qt.NoModifier
    )
    ...
    release_event = QMouseEvent(
        QEvent.MouseButtonRelease, p_e4, Qt.RightButton, Qt.NoButton, Qt.NoModifier
    )
    ...
    press_event2 = QMouseEvent(
        QEvent.MouseButtonPress, p_e4, Qt.RightButton, Qt.RightButton, Qt.NoModifier
    )
    ...
    left_press_event = QMouseEvent(
        QEvent.MouseButtonPress, p_e4, Qt.LeftButton, Qt.LeftButton, Qt.NoModifier
    )
